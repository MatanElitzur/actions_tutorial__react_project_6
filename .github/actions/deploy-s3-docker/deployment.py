...
def run():
    #Github action creates for any input paramaters located at action.yml
    #the same paramater but with a INPUT_ prefix and with the same name but with uppercase 
